...
In the future browser will not require compilers like TypeScript they will be able to handle the class syntax natively.
Microsoft Edge, Firefox and Chrome already do.

# 5. Template Strings

Traditionally in JavaScript we would join strings and variable together using +. Whilst this works it can be messy when you are working
